    ...
    getElementCoords(elem: HTMLDivElement | null) {
        ...
        function getStyle(el: any, styleProp: any) {
            ...
            if (defaultView && defaultView.getComputedStyle) {
                ...
                styleProp = styleProp.replace(/\-(\w)/g, function (str: any, letter: string) {
        ...
        function findAncestor(el: any, cls:any) {
            let countBreak = 1;
            while ((el = el.parentElement) && cls.filter((x: any) => el.classList.contains(x)).length === 0 && countBreak < 10 && countBreak++);
            return el;
        }
